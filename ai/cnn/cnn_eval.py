...
# df_orig = pd.read_csv("C:\\Users\melgibson\\Admiral Markets MT5\\MQL5\\Files\\Testing.csv")
colums_needed=list(pd.read_csv("columns_needed.csv",header=None).T.values[0])
print(colums_needed)
